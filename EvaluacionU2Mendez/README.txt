...
a persistence unit "EvaluacionU2MendezPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ups/edu/ec/EvaluacionU2Mendez/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "EvaluacionU2Mendez/pom.xml":
...
artifact ("EvaluacionU2Mendez.war") is already built. You can build
